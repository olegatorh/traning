    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+41524204141', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('country', django_countries.fields.CountryField(default='Ukraine', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Lviv', max_length=180, verbose_name='City')),
